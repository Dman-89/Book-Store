...
public class MockDataGenerator {
    ...
    private static final String[] products = {"book", "journal", "newspaper", "pen", "pencil", "notebook", "eraser",
            "card", "gift card", "map", "postcard"};
    ...
    public static String getRandomProductName() {
        return products[new Random().nextInt(products.length)] + " " + getRandomNumber(3);
    }
